...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('backend/doctors.doctors')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('backend/doctors.add_doctor')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->			
                ...
                <div class="card-body">
                    <form action="{{ route('doctors.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        <option selected value="" selected disabled>{{'doctors.data'}}</option>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">{{ trans('backend/doctors.doctor_photo') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <button type="submit" class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{ trans('backend/doctors.submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
