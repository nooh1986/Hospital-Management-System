...
@section('title')
    {{trans('backend/patiens.Add_patien')}}
@stop
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('backend/patiens.patiens')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('backend/patiens.Add_patien')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select name="gender" class="form-control SlectBox">
                                        ...
                                        <option value="1">{{trans('backend/patiens.male')}}</option>
                                        <option value="0">{{trans('backend/patiens.female')}}</option>
                                    </select>
                                </div>
