        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">
                    {{ trans('backend/patiens.Title_deleted') }}
                </h5>
            ...
            <div class="modal-body">
                {!! Form::open(['route' => ['Patients.destroy' , 'test'], 'class' => 'form' , 'method'=>'delete' ]) !!}
                    {{ trans('backend/patiens.Deleted') }}
                    <br>

                    {!! Form::hidden('id', old('id' , $patient->id)) !!}  
                    <br>
